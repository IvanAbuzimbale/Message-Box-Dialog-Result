...
namespace Message_Box_Dialog_Result
{
    public partial class Form1 : Form
    {
        ...
        private void buttonOtvori_Click(object sender, EventArgs e)
        {
            ...
            switch (rez)
            {
                case DialogResult.Yes: textBoxRezultat.Text = "Izabrali ste dugme YES"; break;

                case DialogResult.No: textBoxRezultat.Text = "Izabrali ste dugme NO"; break;

                case DialogResult.Cancel: textBoxRezultat.Text = "Izabrali ste dugme Cancel"; break;
            }
        }
